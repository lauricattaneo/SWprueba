 ...
 *
 */
class AmparoItemConceptoController extends Controller
{
    /**
    ...
    public function indexAction(Request $request, $id)
    {
        ...
        $expteAmparoItemConceptos = $em->getRepository('SiafcaIntranetBundle:ExpteAmpItemConcepto')->findByamparoItem($id);
        
        return $this->render('amparoItemConcepto/index.html.twig', array(
            'expteAmparoItemConceptos' => $expteAmparoItemConceptos,
        ));
    }
